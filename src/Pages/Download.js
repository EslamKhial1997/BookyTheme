...
const Download = () => {
  ...
  return (
    <section className="authentication-form download" style={{backgroundImage:`url(${process.env.PUBLIC_URL}/assets/images/aut-bg.jpg)`}}>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="text-center">
              <img src={`${process.env.PUBLIC_URL}/assets/images/down.png`} className="img-fluid downlod-img" alt="" />
              <div className="col-lg-8 offset-lg-2">
                <h2>Your download should begin automatically</h2>
              </div>
              <h3>
                If it doesn’t start automatically,{" "}
                <a href="javascript"  className="manual-down" onClick={(e)=>{e.preventDefault()}}>
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="copyright-section">
                  <p>
                    2018-19 Copyright &copy; By Themeforest Powered By Pixel
                    Strap
                  </p>
                </div>
