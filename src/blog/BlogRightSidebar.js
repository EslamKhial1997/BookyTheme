      ...
      <div className="page-margin">
        ...
        <div className="breadcrumb-bg">
          <div className="container">
            <div className="row">
              <div className="col-md-5 col-sm-12 col-text-center d-align-center">
                <h2 className="title">
                  Right<span> Sidebar</span>
                </h2>
              </div>
              <div className="col-md-7 col-sm-12 col-text-center">
                <nav aria-label="breadcrumb" className="blog-bradcrumb ">
                  <ol className="breadcrumb bg-transparent mb-0">
                    ...
                    <li className="breadcrumb-item active">
                      <a href="javascript" onClick={(e)=>{e.preventDefault()}}>Blog Details with Right Sidebar</a>
                    </li>
                  </ol>
                </nav>
              </div>
                  ...
                  <div  className="blog-block" style={bgImg}>
                    <div className="blog-box">
                      <div className="overflow-hidden">
                        <img
                          src={process.env.PUBLIC_URL+"/assets/images/blog/blog-details.jpg"}
                          alt="blog"
                          className="img-fluid"
                        />
                      </div>
