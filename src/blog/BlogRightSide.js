                ...
                <nav aria-label="breadcrumb" className="blog-bradcrumb ">
                  <ol className="breadcrumb bg-transparent mb-0">
                    ...
                    <li className="breadcrumb-item active">
                      <a href="javascript" onClick={(e)=>{e.preventDefault()}}>Right Sidebar</a>
                    </li>
                  </ol>
                </nav>
              </div>
            ...
            <div className="row">
              <div className="col-md-8 col-lg-9 blog-sec">
                <div className="row blog-list">
                      ...
                      <div className="blog-block" style={bgImg}>
                        <div className="blog-box">
                          <div className="overflow-hidden">
                            <a href="blog-details">
                              <img
                                src={process.env.PUBLIC_URL+"/assets/images/blog/blog3.jpg"}
                                alt="blog"
                                className="img-fluid"
                              />
                            </a>
                  ...
                  <div className="col-lg-6 col-md-12">
                    <div className="blog-item">
                      <div id="blog-block" className="blog-block" style={bgImg}>
                        <div className="blog-box">
                          <div className="overflow-hidden">
                            <a href="blog-details">
                              <img
                                src={process.env.PUBLIC_URL+"/assets/images/blog/6.jpg"}
                                alt="blog"
                                className="img-fluid"
                              />
                            </a>
                      ...
                      <div id="blog-block" className="blog-block" style={bgImg}>
                        <div className="blog-box">
                          <div className="overflow-hidden">
                            <a href="blog-details">
                              <img
                                src={process.env.PUBLIC_URL+"/assets/images/blog/7.jpg"}
                                alt="blog"
                                className="img-fluid"
                              />
                            </a>
                      ...
                      <div id="blog-block" className="blog-block" style={bgImg}>
                        <div className="blog-box">
                          <div className="overflow-hidden">
                            <a href="blog-details">
                              <img
                                src={process.env.PUBLIC_URL+"/assets/images/blog/8.jpg"}
                                alt="blog"
                                className="img-fluid"
                              />
                            </a>
                      ...
                      <div id="blog-block" className="blog-block" style={bgImg}>
                        <div className="blog-box">
                          <div className="overflow-hidden">
                            <a href="blog-details">
                              <img
                                src={process.env.PUBLIC_URL+"/assets/images/blog/9.jpg"}
                                alt="blog"
                                className="img-fluid"
                              />
                            </a>
                      ...
                      <div id="blog-block" className="blog-block" style={bgImg}>
                        <div className="blog-box">
                          <div className="overflow-hidden">
                            <a href="blog-details">
                              <img
                                src={process.env.PUBLIC_URL+"/assets/images/blog/10.jpg"}
                                alt="blog"
                                className="img-fluid"
                              />
                            </a>
              ...
              <div className="col-md-4 col-lg-3 order-md-last list-sidebar">
                <div className="sidebar">
                  ...
                  <div className="recent-blog marg-20">
                    <div className="media">
                      <img className="mr-3" src={process.env.PUBLIC_URL+"/assets/images/blog/1.jpg"} alt="blog" />
                    ...
                    <div className="media">
                      <img className="mr-3" src={process.env.PUBLIC_URL+"/assets/images/blog/2.jpg"} alt="blog" />
                      <div className="media-body">
                        <a href="blog-details">
                    ...
                    <div className="media">
                      <img className="mr-3" src={process.env.PUBLIC_URL+"/assets/images/blog/3.jpg"} alt="blog" />
                      <div className="media-body">
                        <a href="blog-details">
                          <h5 className="mt-0">
                            all the Lorem Ipsum Generator
                          </h5>
                        </a>
